...
def test_login_route():
    ...
    response = CLIENT.post(
        reverse("login"),
        {"username": "testuser@testing.com", "password": "TestPassword"},
    )  # noqa
...
def test_login_route_failed_wrong_password():
    ...
    response = CLIENT.post(
        reverse("login"),
        {"username": "testuser@testing.com", "password": "WrongPassword"},
    )  # noqa
...
def test_login_route_failed_wrong_username():
    ...
    response = CLIENT.post(
        reverse("login"), {"username": "WrongUsernam", "password": "TestPassword"}
    )  # noqa
    assertTemplateUsed(response, "accounts/login.html")
...
def test_login_route_failed():
    ...
    response = CLIENT.post(
        reverse("login"), {"username": "WrongUsername", "password": "WrongPassword"}
    )  # noqa
    assertTemplateUsed(response, "accounts/login.html")
